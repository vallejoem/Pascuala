...
import 'swiper/css';  // Importa el CSS básico de Swiper
        ...
        <div className="z-30 bg-white fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center ">
            <div className="p-8 max-w-md md:max-w-none bg-gray-100 rounded-lg">
                ...
                <div className="mt-3 md:mt-16 mb-6 md:grid md:grid-cols-6">
                    {/* Para pantallas grandes, muestra las miniaturas a la izquierda */}
                    <div className='hidden md:flex flex-col items-center'>
                        {product.images.map((image, index) => (
                            <img
                                ...
                                className={`mt-4 h-52 w-full w-5/6 object-contain object-center cursor-pointer ${selectedImage === image ? 'border-2 border-fuchsia-700' : ''}`}
                    ...
                    {/* Imagen principal */}
                    <div className='hidden md:flex md:flex-col md:col-span-3 md:justify-center md:items-center'>
                        <h3 className="w-full text-xl font-semibold text-gray-900 md:hidden ">{product.name}</h3>
                        <img
                            src={`http://localhost:3500/public/products/${selectedImage}`}  // Muestra la imagen seleccionada
                    ...
                    <div className="md:hidden">
                        <Swiper spaceBetween={10} slidesPerView={1} onSlideChange={(swiper) => setSelectedImage(product.images[swiper.activeIndex])}>
                            {product.images.map((image, index) => (
                    ...
                    <div className='md:mt-5 flex flex-col col-span-2'>
                        ...
                        <h2 className="text-lg py-2 font-bold text-gray-900">Descripción</h2>
